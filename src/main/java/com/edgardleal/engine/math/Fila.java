...
/**
 * Implementa��o do algoritmo de pilha para verifica��o de estisticas com alto desempenho e de
 * tamaho personalizavel.
 * 
 * @author Edgard
 *
 */
public class Fila {
  ...
  private double max = 0.0, min = Double.MAX_VALUE, totalItems = 0.0, totalValor = 0.0;
