...
public class Nomes {
  ...
  private static String primeiro_nome[] = {"ANTONIO", "ANTONIA", "BRUNO", "BRUNA", "CARLOS",
      "CARLA", "DIEGO", "DEBORA", "EDUARDO", "EDUARDA", "FATIMA", "FABIO", "GABRIEL", "GABRIELA",
      "JEREMIAS", "JISELDA", "MARTA", "MIGUEL", "ABEL", "ABIGAIL", "ABELARDO", "ADALGIAS",
      "SORAIA", "YASMIN", "FUGITSU", "DIEGO"};
  private static String segundo_nome[] = {"SANTOS", "SILVA", "MEDEIROS", "ALMEIDA", "BELTR�O",
      "FIGUEREDO", "DUARTE", "MACHADO", "MARTACENIA", "AVELAR", "FERREIRA"};
